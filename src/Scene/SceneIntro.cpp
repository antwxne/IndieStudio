...
SceneIntro::SceneIntro(Setting &settings) : AScene(settings)
{
    ...
    _objects.emplace_back(std::make_shared<Tank>("tankRight", coords(0,0,0), coords(10, 10, 10), std::make_pair(Tank::sable, Tank::body), std::make_pair(Tank::darkGreen, Tank::turret)));
