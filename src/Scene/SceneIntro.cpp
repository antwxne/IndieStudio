...
SceneIntro::SceneIntro(Setting &settings) : AScene(settings)
{
    ...
    _objects.emplace_back(std::make_shared<Tank>("tankRight", coords(0,0,0), std::make_pair(10, 10), std::make_pair(Tank::sable, Tank::body), std::make_pair(Tank::darkGreen, Tank::cannon)));
    //_objects.emplace_back(std::make_shared<Tank>("tankRight", coords(-8,0,7), std::make_pair(10, 10), std::make_pair(Tank::sable, Tank::body), std::make_pair(Tank::darkGreen, Tank::cannon)));
