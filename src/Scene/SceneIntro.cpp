...
SceneIntro::SceneIntro(Setting &settings) : AScene(settings)
{
    ...
    _objects.emplace_back(std::make_shared<Tank>("tankLeft", coords(-8,0,7), coords(10, 10, 10), std::make_pair(Tank::sandCamo, Tank::body), std::make_pair(Tank::greenCamo, Tank::turret)));
    std::dynamic_pointer_cast<Tank>(_objects.back())->rotateCannon(90);
    _objects.emplace_back(std::make_shared<Tank>("tankRight", coords(8,0,-7), coords(10, 10, 10), std::make_pair(Tank::sandCamo, Tank::body), std::make_pair(Tank::greenCamo, Tank::turret)));
