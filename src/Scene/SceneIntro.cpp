...
SceneIntro::SceneIntro(Setting &settings) : AScene(settings)
{
    ...
    _objects.emplace_back(std::make_shared<Tank>("tankLeft", coords(-8,0,7), std::make_pair(10, 10), std::make_pair(Tank::sable, Tank::body), std::make_pair(Tank::darkGreen, Tank::turret)));
