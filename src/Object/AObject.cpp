...
AObject::AObject(const std::pair<int, int> &pos, const std::pair<int, int> &size, std::unique_ptr<IRayObj> func, bool is3D) : _pos(pos), _size(size), _rotation(0), _is3D(is3D)
{
